...
i = 0
tongue_length = 5
amounts = {"Tongue":(2.5, 1.25), "Health":1.0, "Damage":0.35,
           "AttackSpeed":1.15}
levels = {"Tongue":1, "Health":1, "Damage":1,
           "AttackSpeed":1}
costs = {"Tongue":25, "Health":45, "Damage":50,
           "AttackSpeed":50}
...
while(i < upgrades_wanted):
    ...
    if(current_category == "Tongue"):
        current_upgrade["amount"] = amounts[current_category][0]
        current_upgrade["amount2"] = amounts[current_category][1]
    else:
